...
<div id="menu-primary">
    <div class="menu">
        <img class="logo" style="height: 150px;width: 110px;" src="${resource(dir:'images',file:'logo_small.png')}">
...
<div id="panel">
    <div id="banner">
        <div id="left-banner">
            <g:link action="ratedMovies" params="[u:user.username]"><div id="back">Back to All Rated Movies</div></g:link>
        </div>
        <div id="right-banner">
    ...
    <div id="info">
        ...
        <div id="basic-info">
            <img id="movie-img" src=${movie.imgurl}>
            <div>
