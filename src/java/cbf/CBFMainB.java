 ...
 */
public class CBFMainB {
    private static final Logger logger = LoggerFactory.getLogger(CBFMainB.class);

    public static HashMap<String,TreeMap<Number, Number>> results = new HashMap<String,TreeMap<Number, Number>>();

    public CBFMainB(String[] args){
        try {
    ...
    public static void mainRun(String[] args) throws RecommenderBuildException {
